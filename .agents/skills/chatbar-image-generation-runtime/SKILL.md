...
- Prompt-tool character-card selection imports nonblank card style/character source text without resetting the editable NovelAI draft; blank card fields must not erase manual prompts.
