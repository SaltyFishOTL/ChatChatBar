...
- Home image prompt tool, reference-image reverse prompting, or manual NovelAI prompt editing: use chatbar-novelai-prompt and chatbar-image-generation-runtime, then read ui/imageprompt/ImagePromptToolScreen.kt and ImagePromptToolViewModel.kt. Independent studio AI-design conversations use NovelAiDesignScreen.kt, NovelAiDesignViewModel.kt, domain/image/NovelAiDesignConversationModels.kt, and data/repository/NovelAiDesignConversationRepository.kt.
- Prompt-tool image processing, full-image patch apply/restore, static/GIF import, or direct share/save: use chatbar-image-generation-runtime, then read ui/imageprompt/ImageProcessingPage.kt, ImageProcessingViewModel.kt, and domain/image/ImageProcessingService.kt.
