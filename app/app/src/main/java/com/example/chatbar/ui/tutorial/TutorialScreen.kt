        ...
        sections = listOf(
            TutorialSection(
                ...
                steps = listOf(
                    ...
                    "选择 TTS 模型和语音标签模型，再保存全局设置；普通模式下语音标签模型留空时使用当前会话对话模型，听书模式会跳过 AI 标签生成。",
            ...
            TutorialSection(
                ...
                steps = listOf(
                    ...
                    "普通模式进度卡依次显示 AI 标签设计和 Fish Audio 合成；听书模式直接进入 Fish Audio 合成。",
        ...
        sections = listOf(
            TutorialSection(
                ...
                steps = listOf(
                    ...
                    "长按生成图片，可查看并修改主提示词、角色提示词和负面提示词，再按原图尺寸使用新 seed 重新生成；也可删除图片。",
                    "文本正在生成时也可长按图片并重新生图。",
                    "普通聊天图片长按会直接进入删除确认。"
                )
            ),
            TutorialSection(
                ...
                steps = listOf(
                    ...
                    "可选择马赛克、黑色或白色笔刷并调整尺寸后涂抹，也可一键给全图加入中等强度实验性 AI 对抗扰动，或将图片顺时针旋转 90 度；完成后可继续保存、分享，也可把处理后的图片替换为角色卡头像或背景。",
